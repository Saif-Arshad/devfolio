        ...
        <div className="flex flex-wrap h-full w-full">
            ...
            <div className="flex flex-col h-full w-full md:w-1/2 px-4 md:pl-4 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-5 text-white">
                    I am also a strong <a href="#" className="text-primaryColor">communicator</a> and able to effectively collaborate with clients and team members...
                </p>
                <p className="mt-5 text-white">
                    In my free time, I enjoy watching movies and <a href="#" className="text-primaryColor">traveling</a>. I am also an avid learner...
                </p> */}
                {/* <HeroCloud /> */}
            </div>
        </div>
