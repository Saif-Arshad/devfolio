...
function GradualSpacing({
    ...
    delay = 0.015,
    duration = 0.15,
    className = "text-white text-center font-jakarta font-semibold leading-[120%] md:text-[46px] text-[24px]"
}: {
    text: string;
    delay?: number;
    duration?: number;
...
const ServiceDetails = ({ service }: ServiceDetailsProps) => {
    return (
        <div className='flex justify-center mt-6'>
            <div className="space-y-6 max-w-6xl px-6 flex flex-col justify-center items-center">
                ...
                {/* Main Heading */}
                <GradualSpacing
                    text={`What We Do for ${service.title}`}
                />
                ...
                >
                    {service.serviceDetailsDescription}
                </motion.p>
